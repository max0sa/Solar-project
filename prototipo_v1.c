    ...
    do{   /* abro un ciclo para poder utilizarlo en el menu principal cada vez que se inicie
        ...
        switch (opcion1) { // empiezo a utilizar casos que depende de la alternativa numerada antes
            ...
            do{  // abro un submenu que funciona igual que el menu principal
                printf("\n----------categorias----------\n");
                printf("1.Monocristalinos (alto rendimiento, mas caro)\n");
                printf("2.Policristalinos (equilibrado)\n");
                printf("3.Capa fina / Película delgada (menor eficiencia, economico)\n");
                printf("0.Volver al menu principal\n"); // misma condicion que el menu principal deja de iterar al usar 0
                printf("***Los precios estaran ordenados de mayor a menor***\n");
                ...
                switch (opcion2) { // otro submenu 
                    ...
                    printf("Elegiste paneles policristalinos\n");
                    break;

                    case 3: // por ejemplo: si se escoge 3 hara lo siguiente o como un if (opcion1 == 3)
                    printf("Elegiste paneles de capa fina / pelicula delgada\n");
                    break;
